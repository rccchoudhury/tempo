...
class Body3DMviewTemporalPanopticDataset(Kpt3dMviewRgbTemporalDataset):
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('third_party/mmpose/configs/_base_/datasets/panoptic_body3d.py')
        ...
        self.camera_range = range(self.cam_range[0], self.cam_range[1])
        ...
        if self.joints_format == 'coco':
            self.joint_order = self.panoptic_to_coco
    ...
    def load_config(self, data_cfg):
        ...
        assert self.joints_format in ['coco', 'panoptic']
    ...
    def _get_db(self):
        ...
        for seq in self.seq_list:
            ...
            for i, file in enumerate(anno_files):
                if self.subset in ['validation',] and i > 0.3 * len(anno_files):
                  break
                if i % self.seq_frame_interval == 0:
                    ...
                    for k, cam_param in cameras.items():
                        ...
                        for body in bodies:
                            ...
                            pose3d = pose3d[self.joint_order]
                            ...
                            # use np.mean here so it can accept multiple root
                            # indices, such as left/right hip.
                            #pdb.set_trace()
    ...
    def evaluate(self, results, res_folder=None, metric='mpjpe', **kwargs):
        ...
        for i in range(gt_num):
            # Introduce this to match the validation set of the other methods,
            # which use seq_val_freq = 12.
    ...
    def _eval_list_to_mpjpe(eval_list, threshold=500):
        ...
        valid_scores = np.array(valid_scores)
        mpjpes = np.array(mpjpes)[valid_scores > 0.3]
    ...
    def __getitem__(self, idx):
        ...
        for t in range(self.horizon):
            ...
            for c in range(self.num_cameras):
                result = copy.deepcopy(self.db[self.num_cameras * (idx + t) +
                                               c])
