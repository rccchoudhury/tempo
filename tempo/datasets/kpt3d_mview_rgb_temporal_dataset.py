...
class Kpt3dMviewRgbTemporalDataset(Dataset, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        self.ann_info['sub_cube_size'] = data_cfg['sub_cube_size']
        self.ann_info['sub_space_size'] = data_cfg['sub_space_size']
        self.ann_info['joints_format'] = data_cfg['joints_format']
    ...
    def __len__(self):
        ...
        return len(self.db) // self.num_cameras - self.horizon + 1
    ...
    def _load_files(self):
        ...
        self.gt_pose_db = np.array(np.array(list(
            gt['actor3D'])).tolist()).squeeze()
